defmodule Uppy.Phases.HeadSchemaObjectMetadataTest do
  use Uppy.DataCase, async: true
  doctest Uppy.Phases.HeadSchemaObjectMetadata

  alias Uppy.{
    Fixture,
    Resolution,
    StorageSandbox,
    Phases.HeadSchemaObjectMetadata
  }
