defmodule Uppy.Schedulers.ObanScheduler.Events do
  @moduledoc "Event names for oban workers"
  ...
  ### Examples
      ...
      iex> Uppy.Schedulers.ObanScheduler.Events.list()
  ...
  ### Examples
      ...
      iex> Uppy.Schedulers.ObanScheduler.Events.abort_multipart_upload()
  ...
  ### Examples
      ...
      iex> Uppy.Schedulers.ObanScheduler.Events.abort_upload()
      "uppy.abort_upload"
  """
  ...
  ### Examples
      ...
      iex> Uppy.Schedulers.ObanScheduler.Events.move_upload()
      "uppy.move_upload"
  """
