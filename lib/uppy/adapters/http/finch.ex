if Uppy.Utils.application_loaded?(:finch) do
  defmodule Uppy.Adapters.HTTP.Finch do
    ...
    """
    alias Uppy.Adapters.HTTP.Finch.Response

    @type t_res :: Uppy.t_res(Response.t())
    ...
    def child_spec(name) when is_atom(name) do
      %{
        id: name,
        start: {Uppy.Adapters.HTTP.Finch, :start_link, [name]}
      }
    end
    ...
    def child_spec({name, opts}) do
      %{
        id: name,
        start: {Uppy.Adapters.HTTP.Finch, :start_link, [name, opts]}
      }
    end
    ...
    def child_spec(opts) do
      ...
      %{
        id: opts[:name],
        start: {Uppy.Adapters.HTTP.Finch, :start_link, [opts[:name], opts]}
      }
    end
    ...
    ### Examples
        ...
        iex> Uppy.Adapters.HTTP.Finch.patch("http://url.com", nil)
    """
    ...
    ### Examples
        ...
        iex> Uppy.Adapters.HTTP.Finch.post("http://url.com", nil)
    """
    ...
    def post(url, body, headers \\ [], options \\ []) do
      ...
      :exit, reason ->
        {:error,
         ErrorMessage.service_unavailable(
           "Uppy.Adapters.HTTP.Finch post exited: #{inspect(reason)}"
         )}
    end
    ...
    ### Examples
        ...
        iex> Uppy.Adapters.HTTP.Finch.put("http://url.com", nil)
    """
    ...
    ### Examples
        ...
        iex> Uppy.Adapters.HTTP.Finch.head("http://url.com")
    """
    ...
    ### Examples
        ...
        iex> Uppy.Adapters.HTTP.Finch.get("http://url.com")
    """
    ...
    def get(url, headers \\ [], options \\ []) do
      ...
      :exit, reason ->
        {:error,
         ErrorMessage.service_unavailable(
           "Uppy.Adapters.HTTP.Finch get exited: #{inspect(reason)}"
         )}
    end
    ...
    ### Examples
        ...
        iex> Uppy.Adapters.HTTP.Finch.delete("http://url.com")
    """
    ...
    defp handle_response({:error, %Mint.TransportError{reason: :econnrefused} = e}, opts) do
      ...
      {:error, ErrorMessage.service_unavailable(message, %{error: e})}
    end
  ...
  if Uppy.Config.http_adapter() === Uppy.Adapters.HTTP.Finch do
    raise """
    Uppy is configured to use the http adapter `Uppy.Adapters.HTTP.Finch`
